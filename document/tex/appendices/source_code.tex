...
\begin{document}
  ...
  \label{chap:how_it_was_build}
    ...
    \section{\texttt{graph package}}
      ...
      \begin{figure}
        \centering
        \inputminted[lastline=55,linenos]{python}{../src/tf_G/graph/graph.py}
      ...
      \begin{figure}
        \centering
        \inputminted[firstline=56,linenos]{python}{../src/tf_G/graph/graph.py}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/graph/graph_constructor.py}
    ...
    \section{\texttt{pagerank package}}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/pagerank/pagerank.py}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/pagerank/numeric_pagerank.py}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/pagerank/numeric_algebraic_pagerank.py}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/pagerank/numeric_iterative_pagerank.py}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/pagerank/transition/transition_matrix.py}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/pagerank/transition/transition_reset_matrix.py}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/pagerank/transition/transition_random.py}
    ...
    \section{\texttt{utils package}}
      ...
      \begin{figure}
        \centering
        \inputminted[linenos]{python}{../src/tf_G/utils/datasets.py}
