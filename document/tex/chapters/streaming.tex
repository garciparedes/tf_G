  ...
  \label{chapter:streaming}
    ...
    \label{sec:streaming_morris_algorithm}
      ...
      \begin{itemize}
        ...
        \item $\rho(y)$ La función $\rho$ devuelve la posición en la cual se encuentra el bit con valor $1$ empezando a contar a partir del menos significativo. Por convenio, devuelve el valor $L$ si se $y$ no contiene ningún $1$. Esto se modeliza matemáticamente en la ecuación \eqref{eq:rho_function}.
      \end{itemize}
