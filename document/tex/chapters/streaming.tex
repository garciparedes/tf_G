...
\begin{document}
  ...
  \label{chapter:streaming}
    ...
    \label{sec:streaming_morris_algorithm}
      ...
      \paragraph{}
      La intuicción en la cual se basa el \emph{Algoritmo de Flajolet-Martin}, es la transformación de los elementos de entrada sobre una \emph{función Hash} universal binaria con distribución uniforme de probabilidad. La propiedad de distribución uniforme permite entonces preveer que la mitad de los elementos tendrán un $0$ en el bit menos significativo, que una cuarta parte de los elementos tendrán un $0$ en el segundo bit menos significativo y así sucesivamente. Por tanto, a partir de esta idea se puede realizar una aproximación estadística del número de elementos distintos que han sido presentados en la entrada. A continuación se explica el esta estrategia.
