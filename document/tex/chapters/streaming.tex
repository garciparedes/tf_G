...
\begin{document}
  ...
  \label{chapter:streaming}
    ...
    \label{sec:streaming_model}
      ...
      \paragraph{}
      En los siguientes apartados se expone la clasificación que propone Muthukrishnan \cite{Muthukrishnan:2005:DSA:1166409.1166410} y cuya notación serán seguida durante el resto del capítulo.
