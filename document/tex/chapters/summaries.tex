  ...
  \label{chapter:summaries}
    ...
    \label{sec:summaries_types}
      ...
      \label{sec:sketch}
        ...
        \paragraph{}
        Los \emph{Sketches} son una estrategia de sumarización de información enmarcada dentro del \emph{Modelo en streaming} descrito en la sección \ref{sec:streaming_model}. Dicha estrategia se caracteriza por procesar cada dato de entrada de manera secuencial, frente a otras alternativas como \emph{Sampling}. Los \emph{Sketches lineales} se caracterizan por procesar los datos de entrada realizando una \emph{transformación lineal} sobre cada elemento y una estructura encargada de sumarizar la información de los sucesos previos.
