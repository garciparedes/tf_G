  ...
  \label{chap:graphs}
    ...
    \label{sec:graph_problems}
      ...
      \label{sec:minimum_spanning_tree}
        ...
        \paragraph{}
        Una vez descrito el problema y su estado actual, el resto del apartado se basará en la descripción del mismo sobre las restricciones del \emph{modelo en semi-streaming}. Para ello se realiza una descripción del algoritmo exacto propuesto por \emph{Ahn y otros} en \emph{Analyzing graph structure via linear measurements} \cite{ahn2012analyzing}.


        \paragraph{}
        [TODO aplicaciones del problema]
