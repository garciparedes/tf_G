  ...
  \label{chap:graphs}
    ...
    \label{sec:spanners_sparsifiers}
      ...
      \label{sec:sparsifiers}
        ...
        \paragraph{}
        Por tanto, el problema se reduce al mantenimiento de un \emph{$L_{0}$-Sampler} que mantenga un subconjunto de aristas seleccionados con probabilidad $p$ del stream de aristas.
