    ...
    \label{sec:implementation}
      ...
      \label{sec:implementation_design}
        ...
        \label{sec:components_diagram}
          ...
          \begin{figure}
            \centering
            \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{components-diagram}
            \caption{[TODO ]}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{tensorflow-graph-algebraic-pagerank}
          \caption{[TODO ]}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{tensorflow-graph-iterative-pagerank}
          \caption{[TODO ]}
